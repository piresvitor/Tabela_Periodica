...
Este projeto é uma tabela periódica interativa desenvolvida com HTML, CSS eScript. Ele permite explorar visualmente os elementos químicos de forma dinâmica e interativa.

## 🔍 Funcionalidades

- **Visualização Completa:** Apresenta a Tabela Periódica em formato de grid.
- **Renderização de Elementos:** Organização dos elementos com base no período e grupo.
- **Modo Claro/Escuro:** Alternância entre modos de visualização para melhor conforto.
- **Persistência do Modo Visual:** Salva a preferência do modo (claro/escuro) usando `localStorage` para visitas futuras.
